...
public class PhieuMuonDao {
    ...
    public static final String SQL_PHIEU_MUON = "CREATE TABLE PhieuMuon(HoTen " +
            "text, Truong text,Lop text,DiaChi text, SoDienThoai text primary key,NgayDangKy date);";
